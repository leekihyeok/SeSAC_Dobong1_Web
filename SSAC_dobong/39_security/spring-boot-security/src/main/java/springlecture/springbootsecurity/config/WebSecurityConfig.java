...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource(){
        ...
        config.setAllowedMethods(Arrays.asList("HEAD", "POST", "DELETE", "PUT", "GET", "PATCH"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
                ...
                // withDefault - Bean으로 등록된 corsConfiqurationSource 라는 메소드를 찾아서 해줌
                ...
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .anyRequest().authenticated() // 위에 걸러지지 않은 api는 모두 인증을 필요로 함
                        // .permitAll() - 인증 X 접근 가능
                        // .hasRole("admin") - 특정 role이 있어야 접근 가능 (ex. admin)
